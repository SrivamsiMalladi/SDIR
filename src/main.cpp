...
//            cout << t << endl;
            ...
            if(jsonHandler.get_op_mode() == OpMode::POS_2_CFG){
                ...
                //pos = SixDPos(314.099985, 31.3148732, 2934.78492, 0.217491, 0.226049, 1.3025);
                //pos = SixDPos(92.4075420, - 668.540585, 2741.34524, -0.301005, 0.22401, - 1.61619);

                
                cout <<"Data from contoller: "<< jsonHandler.get_json_string(&pos) << endl;
